...
Building on netCDF, \textbf{xarray} features two main data structures: the \verb|DataArray| and the \verb|Dataset|. The API for these data structures is summarized in Figure \ref{fig:xarray-public-api}.
